...
public class Main {
	...
	public static void main(String[] args) {
		...
		int n = JOptionPane.showOptionDialog(frame, "Would you like to use console or GUI?","Menu Choice",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,options,options[0]);
