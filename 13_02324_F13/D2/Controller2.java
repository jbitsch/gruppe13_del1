...
public class Controller2 {
	...
	public synchronized void run(int port) {
		...
		try {
			...
			gui.notificationDialog("Du skal forbinde en terminal til port: "
					+ port);
			data.getCon(portdst);
	...
	private class PhysicalScaleSim implements Runnable {
		...
		/**
		 * The method used to start the thread. The method will listen for input
		 * constantly. If an input is given, it will perform the specified
		 * action
		 */
